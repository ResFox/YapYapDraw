...
public class DarkHighJump : ISpecialAction
{
    public override string Name => "Dark High Jump (tower)";
    ...
    {
        if (info.StatusID == 2755 && info.TargetID == ((IGameObject)Svc.Objects.LocalPlayer).GameObjectId)
        {
            DrawManager.Draw(new DrawElement
            {
                ...
                {
                    ActionID = new HashSet<uint> { 26382u },

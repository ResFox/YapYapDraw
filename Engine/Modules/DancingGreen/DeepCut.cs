...
public class DeepCut : ISpecialAction
{
	...
	{
		IGameObject val = Svc.Objects.FirstOrDefault((IGameObject o) => o.BaseId == 18358);
		if (icon == 471 && val != null)
		{
			HitCounter hitCounter = new HitCounter
			{
				ActionID = new HashSet<uint> { 42694u }
			};
			SimpleElement.FanToTarget(val, target, 60f, 45, Follow: true, default, 0f, 3000f, hitCounter);
		}
	}
}

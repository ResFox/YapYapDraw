...
public class PastFutureTermination : ISpecialAction
{
    private bool isFront;

    public override string Name => "Past/Future Termination";
    ...
    {
        if (info.ActionId - 47826 > 1)
            return;

        isFront = info.ActionId == 47826;
    ...
    public override void OnAbilityCast(ActorAbilityInfo info)
    {
        if (info.ActionId - 47830 <= 3)
        {
            ...
            DrawElement element = new DrawElement
            {
                ...
                refOffsetRotation = (isFront ? 0.Degrees() : 180.Degrees()),
                hitCounter = new HitCounter
                {
